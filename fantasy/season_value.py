...
def main() -> int:
    ...
    print(f"\nFor comparison, the draft-strategy edge measured by backtest.py was")
    print(f"+44 points a season — the gap between using the wait-cost rule and")
    print(f"simply drafting the consensus list.")
    return 0
